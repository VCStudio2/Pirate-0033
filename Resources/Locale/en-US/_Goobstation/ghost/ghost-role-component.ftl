...
ghost-role-information-Hecu-description = Follow any and all orders provided to you by Central Command. Otherwise, cooperate with Security to resolve the station's issues.
