...
blob-chem-reactivespines-info = Реактивні шипи
                                Завдають 8 тупої, 8 ріжучої, 8 колючої та 150 структурної шкоди.
blob-chem-blazingoil-info = Палаюча олія
                            Завдає 15 теплової та 150 структурної шкоди, підпалює ціль.
                            Робить вас вразливими до води.
blob-chem-regenerativemateria-info = Регенеративна матерія
                                    Завдає 150 структурної та 15 отруйної шкоди.
                                    Ядро клякси відновлюється вдесятеро швидше, а ресурсні клякси виробляють на 1 ресурс більше.
blob-chem-explosivelattice-info = Вибухова решітка
                                    Завдає 5 теплової та 150 структурної шкоди й підриває ціль, завдаючи 10 тупої шкоди.
                                    Спори вибухають після смерті.
                                    Ви стаєте невразливими до вибухів.
                                    Ви отримуєте на 50% більше теплової та електричної шкоди.
blob-chem-electromagneticweb-info = Електромагнітна павутина
                                    Завдає 20 теплової та 150 структурної шкоди; кожна атака має 20% шанс спричинити ЕМІ.
                                    Плитки клякси спричиняють ЕМІ після знищення.
                                    Ви отримуєте на 25% більше тупої й теплової шкоди.
blob-chem-comatosefiber-info = Коматозне волокно
                                Завдає 22 шкоди від задухи та 150 структурної шкоди.
blob-chem-chaincoating-info = Ланцюгове покриття
                                Завдає по 12 ріжучої та тупої шкоди й 150 структурної шкоди.
                                Клякса стає стійкішою до всіх типів шкоди.
                                Виробництво ресурсів зменшується.
blob-chem-sinewytendons-info = М'язисті сухожилля
                                Кожен удар лікує 8 тупої, ріжучої, отруйної, колючої, холодової й теплової шкоди та шкоди від задухи.
                                Частота пульсів збільшується, а максимальна кількість спороносців зростає з 3 до 5.
                                Фабрики й ресурсні клякси дешевшають.
blob-chem-corrosiveslime-info = Їдкий слиз
                                Завдає 320 структурної, 2 клітинної та 13 кислотної шкоди.
                                Вартість вузла клякси зростає з 50 до 100.
blob-chem-cryogenicpoison-info = Кріогенна отрута
                                Завдає 16 холодової, 4 ріжучої та 100 структурної шкоди.
...
blob-alert-critical-NoNukeCode = Біозагроза критичного рівня. Центральне Командування наказує всьому персоналу, що залишився, укритися та чекати на рятунок.
...
blob-alert-shuttle-arrived = На борту виявлено біозагрозу. Увесь персонал має негайно евакуюватися